...
from .views import index, other_page, BBLoginView, profile, BBLogoutView, ChangeUserInfoView, \
    BBPasswordChangeView, RegisterUserView, user_activate, RegisterDoneView,\
    DeleteUserView, BBPasswordResetView, BBPasswordResetDoneView,\
    BBPasswordResetConfirmView, BBPasswordResetCompleteView, by_rubric,\
    detail, profile_bb_detail, profile_bb_add, profile_bb_change, profile_bb_delete
